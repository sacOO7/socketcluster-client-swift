#
#  Be sure to run `pod spec lint ScClient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/egeniq-forks/socketcluster-client-swift.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Sources/ScClient/**/*"
